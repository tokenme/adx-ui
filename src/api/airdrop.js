...
export default {
  ...
  stats(token, payload) {
    return axios.get('/airdrop/stats', {
      params: payload,
      headers: {
        'Authorization': 'Bearer ' + token
      }
  ...
  applyPublisher(token) {
    return axios.get('/airdrop/publisher/apply', {
      headers: {
        'Authorization': 'Bearer ' + token
      }
    }).then((response) => {
  ...
  withdraw(token, payload) {
    return axios.post('/airdrop/withdraw', payload, {
      headers: {
        'Authorization': 'Bearer ' + token
      }
    }).then((response) => {
